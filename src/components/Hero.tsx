...
const SocialMediaIllustration = () => (
  <div className="relative w-full h-full flex items-center justify-center">
    ...
    <svg viewBox="0 0 120 120" className="w-full h-full relative z-10" fill="none">
      ...
      <circle cx="60" cy="30" r="6" fill="rgba(0,122,255,0.4)" />
      <circle cx="35" cy="45" r="9" fill="url(#nodeGrad2)" stroke="rgba(255,255,255,0.15)" strokeWidth="1" />
      <circle cx="35" cy="45" r="4" fill="rgba(98,98,98,0.4)" />
      ...
      <circle cx="50" cy="75" r="3.5" fill="rgba(0,122,255,0.35)" />
      <circle cx="70" cy="80" r="7" fill="url(#nodeGrad1)" stroke="rgba(255,255,255,0.12)" strokeWidth="1" />
      <circle cx="70" cy="80" r="3" fill="rgba(98,98,98,0.35)" />
      <circle cx="60" cy="30" r="18" stroke="rgba(0,122,255,0.15)" strokeWidth="0.5" className="animate-[ping_3s_ease-in-out_infinite]" />
      <defs>
        ...
        <radialGradient id="nodeGrad1" cx="40%" cy="35%">
          ...
          <stop offset="100%" stopColor="rgba(0,122,255,0.08)" />
        </radialGradient>
        <radialGradient id="nodeGrad2" cx="40%" cy="35%">
          <stop offset="0%" stopColor="rgba(255,255,255,0.12)" />
          <stop offset="100%" stopColor="rgba(98,98,98,0.08)" />
        </radialGradient>
      </defs>
    </svg>
  </div>
...
const MetaAdsIllustration = () => (
  <div className="relative w-full h-full flex items-center justify-center">
    ...
    <svg viewBox="0 0 120 120" className="w-full h-full relative z-10" fill="none">
      ...
      <circle cx="60" cy="60" r="13" stroke="rgba(98,98,98,0.3)" strokeWidth="1" fill="none" />
      <circle cx="60" cy="60" r="6" fill="rgba(0,122,255,0.5)" />
      <circle cx="60" cy="60" r="2.5" fill="rgba(255,255,255,0.6)" />
      <circle r="3" fill="#007AFF" opacity="0.7">
      ...
      <defs>
        <linearGradient id="orbitGrad" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#626262" stopOpacity="0.5" />
        ...
        <linearGradient id="orbitGrad2" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <stop offset="100%" stopColor="#626262" stopOpacity="0.15" />
        </linearGradient>
        <radialGradient id="targetGrad" cx="40%" cy="35%">
          <stop offset="0%" stopColor="rgba(255,255,255,0.12)" />
          <stop offset="100%" stopColor="rgba(98,98,98,0.06)" />
        </radialGradient>
      </defs>
    </svg>
  </div>
...
const WebDesignIllustration = () => (
  <div className="relative w-full h-full flex items-center justify-center">
    ...
    <svg viewBox="0 0 120 120" className="w-full h-full relative z-10" fill="none">
      ...
      <rect x="24" y="72" width="22" height="18" rx="2" fill="url(#blockGrad3)" opacity="0.3" stroke="rgba(0,122,255,0.12)" strokeWidth="0.5" />
      <rect x="49" y="72" width="22" height="18" rx="2" fill="url(#blockGrad3)" opacity="0.25" stroke="rgba(98,98,98,0.12)" strokeWidth="0.5" />
      ...
      <defs>
        ...
        <linearGradient id="blockGrad3" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="rgba(255,255,255,0.08)" />
          <stop offset="100%" stopColor="rgba(0,122,255,0.04)" />
        </linearGradient>
      </defs>
    </svg>
  </div>
...
const CreativeDesignIllustration = () => (
  <div className="relative w-full h-full flex items-center justify-center">
    ...
    <svg viewBox="0 0 120 120" className="w-full h-full relative z-10" fill="none">
      ...
      <circle cx="45" cy="25" r="1.5" fill="rgba(0,122,255,0.6)" className="animate-glow-pulse" />
      <circle cx="95" cy="58" r="1.5" fill="rgba(73,227,255,0.5)" className="animate-glow-pulse" style={{ animationDelay: "1s" }} />
      <circle cx="50" cy="95" r="1" fill="rgba(98,98,98,0.5)" className="animate-glow-pulse" style={{ animationDelay: "2s" }} />
      <defs>
        <radialGradient id="orbGrad" cx="40%" cy="35%">
          <stop offset="0%" stopColor="rgba(255,255,255,0.12)" />
          <stop offset="50%" stopColor="rgba(98,98,98,0.1)" />
          <stop offset="100%" stopColor="rgba(0,122,255,0.05)" />
        </radialGradient>
        <radialGradient id="orbInner" cx="45%" cy="40%">
          <stop offset="0%" stopColor="rgba(0,122,255,0.25)" />
        ...
        <linearGradient id="shapeGrad1" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="rgba(98,98,98,0.1)" />
        </linearGradient>
        <linearGradient id="shapeGrad2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="rgba(98,98,98,0.35)" />
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle at ${50 + (hover ? local.x : globalMouse.x) * 30}% ${50 + (hover ? local.y : globalMouse.y) * 30}%, rgba(0,122,255,${glowOpacity}), transparent 70%)`,
          }}
        />
        <div
